const globalConfig = {
  ...
  CHAT_INPUT_PLACEHOLDER: 'Type your question, eg. "What are Bones made of?"',
...
const teaserListTexts = {
  ...
  DEFAULT_PROMPTS: [
    {
      description: 'How many bones are in the human body?',
    },
    {
      description: 'What happens when a bone breaks?',
    },
    {
      description: 'How to consult a bone specialist?',
    },
  ],
};
